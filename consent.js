// Shared cookie consent banner — gates Google Analytics and Google AdSense
// behind an actual opt-in choice, rather than loading either unconditionally.
// Reused verbatim across every page via the same markup pattern.
(function () {
  const GA_ID = 'G-7C01HBQGR4';
  const ADSENSE_CLIENT = 'ca-pub-1034682172532206';
